...
if(document.querySelector('.slider-review__wrapper')) {
	new Swiper('.slider-review__wrapper', {
		// effect: 'fade',
		// autoplay: {
		// 	delay: 3000,
		// 	disableOnInteraction: false,
		...
		// Arrows
		navigation: {
			nextEl: '.slider-review__arrows .slider-review__arrow_next',
			prevEl: '.slider-review__arrows .slider-review__arrow_prev',
		},
...
if(document.querySelector('.slider-card')) {
	...
	const cardSliderImages = document.querySelectorAll('.slider-card__image');
	const cardSliderDotts = document.querySelectorAll('.slider-card__dotts .swiper-pagination-bullet');

	for(let index = 0; index < cardSliderImages.length - 2; index++) {
		const cardSliderImage = cardSliderImages[index + 1].querySelector('img').getAttribute('src');
